...
public class TestPolicyConfigurationFactory extends PolicyConfigurationFactory {
    ...
    public PolicyConfiguration getPolicyConfiguration(String contextID, boolean remove) throws PolicyContextException {
        ...
        if (!configurators.containsKey(contextID)) {
            configurators.putIfAbsent(contextID,
                    new TestPolicyConfigurationStateMachine(new TestPolicyConfiguration(contextID)));
        }
        ...
        // According to the contract of getPolicyConfiguration() every
        // PolicyConfiguration returned from here
