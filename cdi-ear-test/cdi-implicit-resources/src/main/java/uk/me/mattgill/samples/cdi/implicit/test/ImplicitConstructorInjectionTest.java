...
@Path("/constructor")
public class ImplicitConstructorInjectionTest {
    ...
    public ImplicitConstructorInjectionTest(@Context UriInfo info) {
        this.info = info;
    }
    ...
    public JsonArray getMessage() {
...

        {
            ...
            builder.add("description", "CDI implicit class with @Context in constructor");
            result.add(builder);
        }
